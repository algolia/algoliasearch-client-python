import 'package:algolia_search/src/model/add_api_key_response.dart';
import 'package:algolia_search/src/model/api_key.dart';
import 'package:algolia_search/src/model/assign_user_id_params.dart';
import 'package:algolia_search/src/model/automatic_facet_filter.dart';
import 'package:algolia_search/src/model/base_get_api_key_response.dart';
import 'package:algolia_search/src/model/base_index_settings.dart';
import 'package:algolia_search/src/model/base_search_params.dart';
import 'package:algolia_search/src/model/base_search_params_without_query.dart';
import 'package:algolia_search/src/model/base_search_response.dart';
import 'package:algolia_search/src/model/base_search_response_redirect.dart';
import 'package:algolia_search/src/model/batch_assign_user_ids_params.dart';
import 'package:algolia_search/src/model/batch_dictionary_entries_params.dart';
import 'package:algolia_search/src/model/batch_dictionary_entries_request.dart';
import 'package:algolia_search/src/model/batch_params.dart';
import 'package:algolia_search/src/model/batch_request.dart';
import 'package:algolia_search/src/model/batch_response.dart';
import 'package:algolia_search/src/model/batch_write_params.dart';
import 'package:algolia_search/src/model/browse_params_object.dart';
import 'package:algolia_search/src/model/browse_response.dart';
import 'package:algolia_search/src/model/built_in_operation.dart';
import 'package:algolia_search/src/model/condition.dart';
import 'package:algolia_search/src/model/consequence.dart';
import 'package:algolia_search/src/model/consequence_hide.dart';
import 'package:algolia_search/src/model/consequence_params.dart';
import 'package:algolia_search/src/model/consequence_query_object.dart';
import 'package:algolia_search/src/model/created_at_response.dart';
import 'package:algolia_search/src/model/cursor.dart';
import 'package:algolia_search/src/model/delete_api_key_response.dart';
import 'package:algolia_search/src/model/delete_by_params.dart';
import 'package:algolia_search/src/model/delete_source_response.dart';
import 'package:algolia_search/src/model/deleted_at_response.dart';
import 'package:algolia_search/src/model/dictionary_entry.dart';
import 'package:algolia_search/src/model/dictionary_language.dart';
import 'package:algolia_search/src/model/dictionary_settings_params.dart';
import 'package:algolia_search/src/model/edit.dart';
import 'package:algolia_search/src/model/error_base.dart';
import 'package:algolia_search/src/model/facet_hits.dart';
import 'package:algolia_search/src/model/facet_ordering.dart';
import 'package:algolia_search/src/model/facets.dart';
import 'package:algolia_search/src/model/facets_stats.dart';
import 'package:algolia_search/src/model/fetched_index.dart';
import 'package:algolia_search/src/model/get_api_key_response.dart';
import 'package:algolia_search/src/model/get_dictionary_settings_response.dart';
import 'package:algolia_search/src/model/get_logs_response.dart';
import 'package:algolia_search/src/model/get_objects_params.dart';
import 'package:algolia_search/src/model/get_objects_request.dart';
import 'package:algolia_search/src/model/get_objects_response.dart';
import 'package:algolia_search/src/model/get_task_response.dart';
import 'package:algolia_search/src/model/get_top_user_ids_response.dart';
import 'package:algolia_search/src/model/has_pending_mappings_response.dart';
import 'package:algolia_search/src/model/highlight_result_option.dart';
import 'package:algolia_search/src/model/hit.dart';
import 'package:algolia_search/src/model/index_settings.dart';
import 'package:algolia_search/src/model/index_settings_as_search_params.dart';
import 'package:algolia_search/src/model/index_settings_as_search_params_semantic_search.dart';
import 'package:algolia_search/src/model/languages.dart';
import 'package:algolia_search/src/model/list_api_keys_response.dart';
import 'package:algolia_search/src/model/list_clusters_response.dart';
import 'package:algolia_search/src/model/list_indices_response.dart';
import 'package:algolia_search/src/model/list_user_ids_response.dart';
import 'package:algolia_search/src/model/log.dart';
import 'package:algolia_search/src/model/log_query.dart';
import 'package:algolia_search/src/model/matched_geo_location.dart';
import 'package:algolia_search/src/model/model_source.dart';
import 'package:algolia_search/src/model/multiple_batch_request.dart';
import 'package:algolia_search/src/model/multiple_batch_response.dart';
import 'package:algolia_search/src/model/operation_index_params.dart';
import 'package:algolia_search/src/model/params.dart';
import 'package:algolia_search/src/model/personalization.dart';
import 'package:algolia_search/src/model/promote_object_id.dart';
import 'package:algolia_search/src/model/promote_object_ids.dart';
import 'package:algolia_search/src/model/ranking_info.dart';
import 'package:algolia_search/src/model/redirect_rule_index_metadata.dart';
import 'package:algolia_search/src/model/redirect_rule_index_metadata_data.dart';
import 'package:algolia_search/src/model/remove_user_id_response.dart';
import 'package:algolia_search/src/model/rendering_content.dart';
import 'package:algolia_search/src/model/replace_source_response.dart';
import 'package:algolia_search/src/model/rule.dart';
import 'package:algolia_search/src/model/save_object_response.dart';
import 'package:algolia_search/src/model/save_synonym_response.dart';
import 'package:algolia_search/src/model/search_dictionary_entries_params.dart';
import 'package:algolia_search/src/model/search_for_facet_values_request.dart';
import 'package:algolia_search/src/model/search_for_facet_values_response.dart';
import 'package:algolia_search/src/model/search_for_facets.dart';
import 'package:algolia_search/src/model/search_for_facets_options.dart';
import 'package:algolia_search/src/model/search_for_hits.dart';
import 'package:algolia_search/src/model/search_for_hits_options.dart';
import 'package:algolia_search/src/model/search_hits.dart';
import 'package:algolia_search/src/model/search_method_params.dart';
import 'package:algolia_search/src/model/search_params_object.dart';
import 'package:algolia_search/src/model/search_params_query.dart';
import 'package:algolia_search/src/model/search_params_string.dart';
import 'package:algolia_search/src/model/search_response.dart';
import 'package:algolia_search/src/model/search_responses.dart';
import 'package:algolia_search/src/model/search_rules_params.dart';
import 'package:algolia_search/src/model/search_rules_response.dart';
import 'package:algolia_search/src/model/search_synonyms_params.dart';
import 'package:algolia_search/src/model/search_synonyms_response.dart';
import 'package:algolia_search/src/model/search_user_ids_params.dart';
import 'package:algolia_search/src/model/search_user_ids_response.dart';
import 'package:algolia_search/src/model/snippet_result_option.dart';
import 'package:algolia_search/src/model/standard_entries.dart';
import 'package:algolia_search/src/model/synonym_hit.dart';
import 'package:algolia_search/src/model/time_range.dart';
import 'package:algolia_search/src/model/update_api_key_response.dart';
import 'package:algolia_search/src/model/updated_at_response.dart';
import 'package:algolia_search/src/model/updated_at_with_object_id_response.dart';
import 'package:algolia_search/src/model/updated_rule_response.dart';
import 'package:algolia_search/src/model/user_highlight_result.dart';
import 'package:algolia_search/src/model/user_hit.dart';
import 'package:algolia_search/src/model/user_id.dart';
import 'package:algolia_search/src/model/value.dart';
