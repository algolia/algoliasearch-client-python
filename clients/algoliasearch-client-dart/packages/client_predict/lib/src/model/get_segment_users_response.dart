...
part 'get_segment_users_response.g.dart';

@JsonSerializable()
final class GetSegmentUsersResponse {
  /// Returns a new [GetSegmentUsersResponse] instance.
  const GetSegmentUsersResponse({
  ...
  bool operator ==(Object other) =>
      ...
      other is GetSegmentUsersResponse &&
  ...
  int get hashCode =>
      segmentID.hashCode +
      users.hashCode +
      previousPageToken.hashCode +
      nextPageToken.hashCode;

  factory GetSegmentUsersResponse.fromJson(Map<String, dynamic> json) =>
      _$GetSegmentUsersResponseFromJson(json);

  Map<String, dynamic> toJson() => _$GetSegmentUsersResponseToJson(this);
