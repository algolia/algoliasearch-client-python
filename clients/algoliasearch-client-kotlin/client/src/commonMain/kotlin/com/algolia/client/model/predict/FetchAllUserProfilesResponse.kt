 ...
 */
@Serializable
public data class FetchAllUserProfilesResponse(

  @SerialName(value = "users") val users: List<UserProfile>,
  ...
  @SerialName(value = "previousPageToken") val previousPageToken: String? = null,
