...
public sealed interface SearchQuery {
  ...
  public companion object {
    ...
    public fun SearchForFacets(
      ...
      insideBoundingBox: List<List<Double>>? = null,
      insidePolygon: List<List<Double>>? = null,
    ...
    ): SearchForFacets = com.algolia.client.model.search.SearchForFacets(
      facet = facet,
      indexName = indexName,
      type = type,
      params = params,
    ...
    public fun SearchForHits(
      ...
      enableReRanking: Boolean? = null,
      reRankingApplyFilter: ReRankingApplyFilter? = null,
      type: SearchTypeDefault? = null,
    ): SearchForHits = com.algolia.client.model.search.SearchForHits(
      indexName = indexName,
      params = params,
      query = query,
      similarQuery = similarQuery,
...
internal class SearchQuerySerializer : KSerializer<SearchQuery> {
  ...
  override fun deserialize(decoder: Decoder): SearchQuery {
    ...
    if (tree is JsonObject) {
      try {
        return codec.json.decodeFromJsonElement<SearchForFacets>(tree)
      } catch (e: Exception) {
    ...
    if (tree is JsonObject) {
      try {
        return codec.json.decodeFromJsonElement<SearchForHits>(tree)
      } catch (e: Exception) {
        // deserialization failed, continue
