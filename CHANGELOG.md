## [4.47.0](https://github.com/algolia/algoliasearch-client-python/compare/4.46.0...4.47.0)
...
- [dc0f9dacc5](https://github.com/algolia/api-clients-automation/commit/dc0f9dacc5) feat(python): BREAKING CHANGE – expose maximum number of retries ([#6404](https://github.com/algolia/api-clients-automation/pull/6404)) by [@eric-zaharia](https://github.com/eric-zaharia/)
...
## [4.40.0](https://github.com/algolia/algoliasearch-client-python/compare/4.39.0...4.40.0)
...
- [0102038e25](https://github.com/algolia/api-clients-automation/commit/0102038e25) feat(python): add TransformationOptions object ([#6255](https://github.com/algolia/api-clients-automation/pull/6255)) by [@eric-zaharia](https://github.com/eric-zaharia/)
...
## [4.39.0](https://github.com/algolia/algoliasearch-client-python/compare/4.38.1...4.39.0)
...
- [4ffa68609](https://github.com/algolia/api-clients-automation/commit/4ffa68609) fix(python): restore sync gzip negotiation and add regression test ([#6023](https://github.com/algolia/api-clients-automation/pull/6023)) by [@jonatandellagostin](https://github.com/jonatandellagostin/)

## [4.37.0](https://github.com/algolia/algoliasearch-client-python/compare/4.36.1...4.37.0)
...
## [4.36.1](https://github.com/algolia/algoliasearch-client-python/compare/4.36.0...4.36.1)
...
## [4.35.1](https://github.com/algolia/algoliasearch-client-python/compare/4.35.0...4.35.1)
...
## [4.35.0](https://github.com/algolia/algoliasearch-client-python/compare/4.34.0...4.35.0)
...
## [4.34.0](https://github.com/algolia/algoliasearch-client-python/compare/4.33.0...4.34.0)
...
## [4.33.0](https://github.com/algolia/algoliasearch-client-python/compare/4.32.0...4.33.0)
...
## [4.32.0](https://github.com/algolia/algoliasearch-client-python/compare/4.31.0...4.32.0)
...
## [4.28.0](https://github.com/algolia/algoliasearch-client-python/compare/4.27.0...4.28.0)
...
## [4.27.0](https://github.com/algolia/algoliasearch-client-python/compare/4.26.0...4.27.0)
...
- [c87a0a741](https://github.com/algolia/api-clients-automation/commit/c87a0a741) chore(python): remove redundant check ([#5338](https://github.com/algolia/api-clients-automation/pull/5338)) by [@shortcuts](https://github.com/shortcuts/)
...
## [4.26.0](https://github.com/algolia/algoliasearch-client-python/compare/4.25.0...4.26.0)
...
- [db05110e0](https://github.com/algolia/api-clients-automation/commit/db05110e0) fix(python): remove warnings for HighlightResult and SnippetResult ([#5284](https://github.com/algolia/api-clients-automation/pull/5284)) by [@shortcuts](https://github.com/shortcuts/)
...
## [4.25.0](https://github.com/algolia/algoliasearch-client-python/compare/4.24.0...4.25.0)
...
- [e793aa8980](https://github.com/algolia/api-clients-automation/commit/e793aa8980) fix(python): change badge to correctly reflect supported python versions ([#5274](https://github.com/algolia/api-clients-automation/pull/5274)) by [@lucasrodes](https://github.com/lucasrodes/)
...
## [4.24.0](https://github.com/algolia/algoliasearch-client-python/compare/4.23.1...4.24.0)
...
## [4.23.1](https://github.com/algolia/algoliasearch-client-python/compare/4.23.0...4.23.1)
...
## [4.21.0](https://github.com/algolia/algoliasearch-client-python/compare/4.20.0...4.21.0)
...
## [4.20.0](https://github.com/algolia/algoliasearch-client-python/compare/4.19.0...4.20.0)
...
## [4.16.5](https://github.com/algolia/algoliasearch-client-python/compare/4.16.4...4.16.5)
...
## [4.16.4](https://github.com/algolia/algoliasearch-client-python/compare/4.16.3...4.16.4)
...
## [4.16.3](https://github.com/algolia/algoliasearch-client-python/compare/4.16.2...4.16.3)
