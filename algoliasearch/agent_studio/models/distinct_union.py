...
class DistinctUnion(BaseModel):
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of DistinctUnion from a JSON string"""
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into DistinctUnion with oneOf schemas: bool, int. Details: "
            + ", ".join(error_messages)
        )
