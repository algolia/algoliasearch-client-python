...
from algoliasearch.agent_studio.models.typo_tolerance_enum import TypoToleranceEnum


class TypoToleranceUnion(BaseModel):
    """
    TypoToleranceUnion
    """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of TypoToleranceUnion from a JSON string"""
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into TypoToleranceUnion with oneOf schemas: TypoToleranceEnum, bool. Details: "
            + ", ".join(error_messages)
        )
