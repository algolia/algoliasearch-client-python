...
class InsideBoundingBoxUnion(BaseModel):
    """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of InsideBoundingBoxUnion from a JSON string"""
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into InsideBoundingBoxUnion with oneOf schemas: List[List[float]], str. Details: "
            + ", ".join(error_messages)
        )
