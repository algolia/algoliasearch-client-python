...
class RemoveStopWordsUnion(BaseModel):
    """
    ...
    oneof_schema_2_validator: Optional[List[SupportedLanguage]] = Field(default=None)
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of RemoveStopWordsUnion from a JSON string"""
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into RemoveStopWordsUnion with oneOf schemas: List[SupportedLanguage], bool. Details: "
            + ", ".join(error_messages)
        )
