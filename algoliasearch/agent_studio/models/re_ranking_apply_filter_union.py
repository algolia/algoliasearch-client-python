...
class ReRankingApplyFilterUnion(BaseModel):
    """
    ...
    oneof_schema_2_validator: Optional[List[Dict[str, object]]] = Field(default=None)

    actual_instance: Union[List[Dict[str, object]], str, None] = None
    one_of_schemas: Set[str] = {"List[Dict[str, object]]", "str"}
    ...
    @model_serializer
    def unwrap_actual_instance(self) -> Union[List[Dict[str, object]], str, Self, None]:
        """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of ReRankingApplyFilterUnion from a JSON string"""
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into ReRankingApplyFilterUnion with oneOf schemas: List[Dict[str, object]], str. Details: "
            + ", ".join(error_messages)
        )
