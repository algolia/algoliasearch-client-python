...
class OptionalWordsUnion(BaseModel):
    """
    OptionalWordsUnion
    """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of OptionalWordsUnion from a JSON string"""
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into OptionalWordsUnion with oneOf schemas: List[str], str. Details: "
            + ", ".join(error_messages)
        )
