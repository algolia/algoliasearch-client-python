...
class LocationItemUnion(BaseModel):
    """
    LocationItemUnion
    """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of LocationItemUnion from a JSON string"""
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into LocationItemUnion with oneOf schemas: int, str. Details: "
            + ", ".join(error_messages)
        )
