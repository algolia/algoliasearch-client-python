...
class AroundRadiusUnion(BaseModel):
    """
    AroundRadiusUnion
    """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of AroundRadiusUnion from a JSON string"""
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into AroundRadiusUnion with oneOf schemas: int, str. Details: "
            + ", ".join(error_messages)
        )
