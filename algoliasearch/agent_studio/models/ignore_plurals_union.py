...
class IgnorePluralsUnion(BaseModel):
    """
    IgnorePluralsUnion
    """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of IgnorePluralsUnion from a JSON string"""
    ...
    def from_json(cls, json_str: Optional[str]) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into IgnorePluralsUnion with oneOf schemas: List[SupportedLanguage], bool. Details: "
            + ", ".join(error_messages)
        )
