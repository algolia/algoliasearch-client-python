...
class TagFilters(BaseModel):
    ...
    oneof_schema_1_validator: Optional[List[TagFilters]] = None
    oneof_schema_2_validator: Optional[StrictStr] = None
    actual_instance: Optional[Union[List[TagFilters], str]] = None
    ...
    @model_serializer
    def unwrap_actual_instance(self) -> Optional[Union[List[TagFilters], str]]:
        """
