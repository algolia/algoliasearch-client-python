...
class AutoFilteringFilterEntry(BaseModel):
    """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of AutoFilteringFilterEntry from a JSON string"""
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into AutoFilteringFilterEntry with oneOf schemas: List[str], str. Details: "
            + ", ".join(error_messages)
        )
