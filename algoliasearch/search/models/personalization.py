...
class Personalization(BaseModel):
    ...
    ranking_score: Optional[StrictInt] = Field(
        default=None, description="The score of the ranking.", alias="rankingScore"
    )
    score: Optional[StrictInt] = Field(
        default=None, description="The score of the event."
    )
    __properties: ClassVar[List[str]] = ["filtersScore", "rankingScore", "score"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "filtersScore": obj.get("filtersScore"),
                "rankingScore": obj.get("rankingScore"),
                "score": obj.get("score"),
            }
        )
        return _obj
