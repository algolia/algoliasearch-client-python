...
class SearchParams(BaseModel):
    ...
    one_of_schemas: List[str] = Literal["SearchParamsObject", "SearchParamsString"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, SearchParamsObject):
            error_messages.append(f"""Type '{type(v)}' is not 'SearchParamsObject'""")
        else:
            match += 1
        if match > 1:
            # more than 1 match
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into SearchParamsObject
        try:
