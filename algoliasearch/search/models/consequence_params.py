...
class ConsequenceParams(BaseModel):
    ...
    custom_ranking: Optional[List[str]] = Field(default=None, alias="customRanking")
    ...
    keep_diacritics_on_characters: Optional[str] = Field(
        default=None, alias="keepDiacriticsOnCharacters"
    )
    ...
    mode: Optional[Mode] = Field(default=None, alias="mode")
    ...
    query: Optional[ConsequenceQuery] = Field(default=None, alias="query")
