...
import algoliasearch.query_suggestions.models
from algoliasearch.query_suggestions import rest
from algoliasearch.query_suggestions.api_response import ApiResponse
from algoliasearch.query_suggestions.configuration import Configuration
from algoliasearch.query_suggestions.exceptions import (
    ApiException,
    ApiValueError,
    BadRequestException,
    ForbiddenException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = "OpenAPI-Generator/4.0.0-alpha.1/python"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(algoliasearch.query_suggestions.models, klass)
