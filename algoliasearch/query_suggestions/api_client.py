...
import query_suggestions.models
from dateutil.parser import parse
from query_suggestions import rest
from query_suggestions.api_response import ApiResponse
from query_suggestions.configuration import Configuration
from query_suggestions.exceptions import (
    ApiException,
    ApiValueError,
    BadRequestException,
    ForbiddenException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(query_suggestions.models, klass)
