...
class FrequentlyBoughtTogether(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FrequentlyBoughtTogether from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FrequentlyBoughtTogether from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"model": obj.get("model"), "objectID": obj.get("objectID")}
        )
        return _obj
