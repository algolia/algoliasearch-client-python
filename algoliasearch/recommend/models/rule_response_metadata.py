...
class RuleResponseMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["lastUpdate"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RuleResponseMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RuleResponseMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"lastUpdate": obj.get("lastUpdate")})
        return _obj
