...
class ParameterValue(BaseModel):
    ...
    oneof_schema_2_validator: Optional[float] = Field(default=None)

    oneof_schema_3_validator: Optional[bool] = Field(default=None)

    oneof_schema_4_validator: Optional[List[str]] = Field(default=None)

    actual_instance: Union[List[str], bool, float, str, None] = None
    ...
    @model_serializer
    def unwrap_actual_instance(self) -> Union[List[str], bool, float, str, Self, None]:
        """
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into ParameterValue with oneOf schemas: List[str], bool, float, str. Details: "
            + ", ".join(error_messages)
        )
