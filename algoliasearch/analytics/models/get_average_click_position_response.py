...
from algoliasearch.analytics.models.average_click_event import AverageClickEvent
...
class GetAverageClickPositionResponse(BaseModel):
    ...
    average: Union[StrictFloat, StrictInt] = Field(
    ...
    dates: List[AverageClickEvent] = Field(description="Average click positions.")
    __properties: ClassVar[List[str]] = ["average", "clickCount", "dates"]
