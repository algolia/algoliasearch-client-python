...
from analytics.models.search_event import SearchEvent
...
class GetSearchesCountResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["count", "dates"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "count": obj.get("count"),
                "dates": [SearchEvent.from_dict(_item) for _item in obj.get("dates")]
