...
from algoliasearch.analytics.models.parameter_reference import ParameterReference
...
class FilterDefinition(BaseModel):
    ...
    parameter: Optional[ParameterReference] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        obj["parameter"] = (
            ParameterReference.from_dict(obj["parameter"])
            if obj.get("parameter") is not None
            else None
        )
