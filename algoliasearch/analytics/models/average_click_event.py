...
class AverageClickEvent(BaseModel):
    """
    AverageClickEvent
    """
    ...
    __properties: ClassVar[List[str]] = ["average", "clickCount", "date"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AverageClickEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AverageClickEvent from a dict"""
        if obj is None:
            return None
