...
from analytics.models.no_results_rate_event import NoResultsRateEvent
from pydantic import Annotated, BaseModel, Field, StrictInt
...
class GetNoResultsRateResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["rate", "count", "noResultCount", "dates"]
