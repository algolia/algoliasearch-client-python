...
class NoClickRateEvent(BaseModel):
    """
    NoClickRateEvent
    """
    ...
    __properties: ClassVar[List[str]] = ["rate", "count", "noClickCount", "date"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NoClickRateEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of NoClickRateEvent from a dict"""
        if obj is None:
            return None
