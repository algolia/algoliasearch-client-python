...
class SearchNoResultEvent(BaseModel):
    """
    SearchNoResultEvent
    """
    ...
    __properties: ClassVar[List[str]] = ["search", "count", "nbHits"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SearchNoResultEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SearchNoResultEvent from a dict"""
        if obj is None:
            return None
