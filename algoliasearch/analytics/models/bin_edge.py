...
class BinEdge(BaseModel):
    ...
    actual_instance: Union[float, int, None] = None
    ...
    @model_serializer
    def unwrap_actual_instance(self) -> Union[float, int, Self, None]:
        """
    ...
    def from_dict(cls, obj: Union[str, Dict[str, Any]]) -> Self:
        """Create an instance of BinEdge from a JSON string"""
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        raise ValueError(
            "No match found when deserializing the JSON string into BinEdge with oneOf schemas: float, int. Details: "
            + ", ".join(error_messages)
        )
