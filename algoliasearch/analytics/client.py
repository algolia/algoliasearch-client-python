...
from algoliasearch.analytics.api_client import ApiClient
from algoliasearch.analytics.api_response import ApiResponse
...
class AnalyticsClient:
    ...
    async def get_average_click_position(
        ...
        return self.get_average_click_position_with_http_info(
            index,
            start_date,
            end_date,
            tags,
    ...
    async def get_click_positions(
        ...
        return self.get_click_positions_with_http_info(
            index,
            start_date,
            end_date,
            tags,
    ...
    async def get_click_through_rate(
        ...
        return self.get_click_through_rate_with_http_info(
            index,
            start_date,
            end_date,
            tags,
    ...
    async def get_conversation_rate(
        ...
        return self.get_conversation_rate_with_http_info(
            index,
            start_date,
            end_date,
            tags,
    ...
    async def get_no_click_rate(
        ...
        return self.get_no_click_rate_with_http_info(
            index,
            start_date,
            end_date,
            tags,
    ...
    async def get_no_results_rate(
        ...
        return self.get_no_results_rate_with_http_info(
            index,
            start_date,
            end_date,
            tags,
    ...
    async def get_searches_count(
        ...
        return self.get_searches_count_with_http_info(
            index,
            start_date,
            end_date,
            tags,
    ...
    async def get_searches_no_clicks(
        ...
        return self.get_searches_no_clicks_with_http_info(
            index,
            start_date,
            end_date,
            limit,
    ...
    async def get_searches_no_results(
        ...
        return self.get_searches_no_results_with_http_info(
            index,
            start_date,
            end_date,
            limit,
    ...
    async def get_status(
        ...
        return self.get_status_with_http_info(
            index, _request_timeout, _request_auth, _content_type, _headers, _host_index
        ).data
    ...
    async def get_top_countries(
        ...
        return self.get_top_countries_with_http_info(
            index,
            start_date,
            end_date,
            limit,
    ...
    async def get_top_filter_attributes(
        ...
        return self.get_top_filter_attributes_with_http_info(
            index,
            search,
            start_date,
            end_date,
    ...
    async def get_top_filter_for_attribute(
        ...
        return self.get_top_filter_for_attribute_with_http_info(
            attribute,
            index,
            search,
            start_date,
    ...
    async def get_top_filters_no_results(
        ...
        return self.get_top_filters_no_results_with_http_info(
            index,
            search,
            start_date,
            end_date,
    ...
    async def get_top_hits(
        ...
        return self.get_top_hits_with_http_info(
            index,
            search,
            click_analytics,
            start_date,
    ...
    async def get_top_searches(
        ...
        return self.get_top_searches_with_http_info(
            index,
            click_analytics,
            start_date,
            end_date,
    ...
    async def get_users_count(
        ...
        return self.get_users_count_with_http_info(
            index,
            start_date,
            end_date,
            tags,
