...
from ingestion.models.on_demand_trigger_type import OnDemandTriggerType
...
class OnDemandTrigger(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "lastRun"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {"type": obj.get("type"), "lastRun": obj.get("lastRun")}
        )
        return _obj
