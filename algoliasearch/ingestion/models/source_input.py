...
from ingestion.models.source_big_commerce import SourceBigCommerce
from ingestion.models.source_big_query import SourceBigQuery
from ingestion.models.source_commercetools import SourceCommercetools
from ingestion.models.source_csv import SourceCSV
from ingestion.models.source_docker import SourceDocker
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, SourceCommercetools):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `SourceCommercetools`"
            )  # noqa: E501
        else:
            match += 1
        ...
        if not isinstance(v, SourceBigCommerce):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `SourceBigCommerce`"
            )  # noqa: E501
        else:
            match += 1
        ...
        if not isinstance(v, SourceDocker):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `SourceDocker`"
            )  # noqa: E501
        else:
            match += 1
        if match > 1:
