...
class GetUserTokenResponse(BaseModel):
    ...
    last_event_at: StrictStr = Field(
        description="Date of last event update. (ISO-8601 format).", alias="lastEventAt"
    )
    scores: Union[str, Any] = Field(description="The userToken scores.")
    __properties: ClassVar[List[str]] = ["userToken", "lastEventAt", "scores"]
