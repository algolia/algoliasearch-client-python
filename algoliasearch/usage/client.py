...
class UsageClient:
    ...
    async def get_index_usage_with_http_info(
        ...
        start_date: Annotated[
            StrictStr,
            Field(
                description="Start date in ISO 8601 format of the time period to analyze."
            ),
        ],
        end_date: Annotated[
            StrictStr,
            Field(
                description="End date in ISO 8601 format of the time period to analyze."
            ),
        ],
        ...
        :type index_name: str
        :param start_date: Start date in ISO 8601 format of the time period to analyze. (required)
        :type start_date: str
        :param end_date: End date in ISO 8601 format of the time period to analyze. (required)
        :type end_date: str
