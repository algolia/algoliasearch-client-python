...
import abtesting.models
from abtesting import rest
from abtesting.api_response import ApiResponse
from abtesting.configuration import Configuration
from abtesting.exceptions import (
    ApiException,
    ApiValueError,
    BadRequestException,
    ForbiddenException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(abtesting.models, klass)
