...
from abtesting.models.filter_effects_empty_search import FilterEffectsEmptySearch
from abtesting.models.filter_effects_outliers import FilterEffectsOutliers
...
class FilterEffects(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["outliers", "emptySearch"]
