...
class CustomSearchParams(BaseModel):
    ...
    custom_search_parameters: Union[str, Any] = Field(alias="customSearchParameters")
    __properties: ClassVar[List[str]] = ["customSearchParameters"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CustomSearchParams from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CustomSearchParams from a dict"""
        if obj is None:
            return None
